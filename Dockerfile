...
RUN apt-get update && apt-get install -y  libcurl4-openssl-dev libgit2-dev libpq-dev libssl-dev libxml2-dev pandoc pandoc-citeproc zlib1g-dev pkg-config && rm -rf /var/lib/apt/lists/*
